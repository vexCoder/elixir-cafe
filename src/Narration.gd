...
func print_message(txt: String) -> void:
	...
	label_node.custom_minimum_size = Vector2(viewport_size.x * 0.10, 0.)
	
	label_container_node.add_theme_constant_override("margin_left", viewport_size.x * 0.25)
	label_container_node.add_theme_constant_override("margin_right", viewport_size.x * 0.25)
	label_container_node.add_theme_constant_override("margin_top", viewport_size.y * 0.25)
	label_container_node.add_theme_constant_override("margin_bottom", viewport_size.y * 0.25)
